          ...
          <Link href="/admin" className="flex items-center gap-2">
            <div className="relative h-8 w-16">
              <Image
                ...
                alt="Shafran"
                fill
                className="absolute inset-0 h-full w-full scale-0 transition-all dark:scale-100 object-contain"
              />
              <Image
                src={logoLight}
                alt="Shafran"
                fill
                className="absolute inset-0 h-full w-full scale-100 transition-all dark:scale-0 object-contain"
              />
            </div>
