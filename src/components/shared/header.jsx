        ...
        <div className="flex items-center gap-1 sm:gap-2">
          <Button variant="icon" size="icon" className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10">
            <Image
              ...
              width={0}
              height={0}
              className="absolute h-4 w-4 sm:h-[1.1rem] sm:w-[1.1rem] md:h-[1.2rem] md:w-[1.2rem] scale-0 rotate-90 transition-all dark:scale-100 dark:rotate-0"
            />
            <Image
              loading="eager"
              ...
              width={0}
              height={0}
              className="h-4 w-4 sm:h-[1.1rem] sm:w-[1.1rem] md:h-[1.2rem] md:w-[1.2rem] scale-100 rotate-0 transition-all dark:scale-0 dark:-rotate-90"
            />
          </Button>
